...
<body>
	...
	<div class="left12">
		...
		</a><br> <a href="userServiceEnroll.html">
			...
			<div id="board-list">
				<table class="board-table">
					<tr>
						...
						<td><c:out value="${memberinfo.m_email}" /></td>
					</tr>
					<tr>
						<th scope="col" class="th-num">이름</th>
						<td><c:out value="${memberinfo.m_name}" /></td>
					</tr>
					<tr>
						<th scope="col" class="th-num">영문이름</th>
						<td>${memberinfo.m_english_name}</td>
					</tr>

					<tr>
						<th scope="col" class="th-num">비밀번호</th>
						<td> <input type="password" value="${memberinfo.m_pwd}" style="border: none;" disabled></td>
						<!-- 비밀번호는 보안상의 이유로 별표 등으로 대체하는 것이 좋습니다 -->
					</tr>
					<tr>
