...
<body>
    ...
    <form action="">
        <div class="left2">
            <img class="dimg" src="/resources/images/theGreen/greenBack2.png" alt="">
        </div>
        <div class="right2">
            <br><br><br><br>
            <p class="fff3"><b>the Green</b></p><br><br>
            <p class="fff1">자유와 모험을 즐기는</p>
            <p class="fff1">나의 첫 "럭셔리 카드"</p>
            <p class="fff1"> </p><br><br><br>
                <button class="custom-btn-b btn-9-b" formaction="/card/design/green">신청하기</button>
            <br><br><br><br>
            <div class="yhb">
                <p class="fff1">연회비 150,000</p><br>
                <p class="fff0">국내전용</p>
