        ...
        <div class="slider">
            ...
            <div class="testimonials">
                <label class="item" for="t-2">
                    ...
                    <img src="/resources/images/thePurple/thePurple3.png" alt="">
                </label>
                <label class="item" for="t-3">
                    <p class="fff2">Design 1</p>
                    <img src="/resources/images/thePurple/thePurple1.png" alt="">
                </label>
                <label class="item" for="t-4">
                    <p class="fff2">Design 2</p>
                    <img src="/resources/images/thePurple/thePurple2.png" alt="">
                </label>
            </div>
            <br />
            <div class="dots">
