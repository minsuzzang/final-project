        ...
        <div class="slider">
            ...
            <div class="testimonials">
                <label class="item" for="t-1">
                    ...
                    <img src="/resources/images/theRed/theRed4.png" alt="">
                </label>
                <label class="item" for="t-2">
                    <p class="fff2">Design 5</p>
                    <img src="/resources/images/theRed/theRed5.png" alt="">
                </label>
                <label class="item" for="t-3">
                    <p class="fff2">Design 1</p>
                    <img src="/resources/images/theRed/theRed1.png" alt="">
                </label>
                <label class="item" for="t-4">
                    <p class="fff2">Design 2</p>
                    <img src="/resources/images/theRed/theRed2.png" alt="">
                </label>
                <label class="item" for="t-5">
                    <p class="fff2">Design 3</p>
                    <img src="/resources/images/theRed/theRed3.png" alt="">
                </label>
            </div>
            <br />
            <div class="dots">
