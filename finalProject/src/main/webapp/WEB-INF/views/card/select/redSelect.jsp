...
<body>
	...
	<div class="left1">
		<div class="slider">
			...
			<input type="radio" name="testimonial" id="t-3" value="design1"checked="checked"> 
			...
			<div class="testimonials">
				<label class="item" for="t-1">
					...
					src="/resources/images/theRed/theRed4.png" alt=""
					onclick="radioCheck('t-1')">
				</label> <label class="item" for="t-2">
					<p class="fff2">Design 5</p> <img
					src="/resources/images/theRed/theRed5.png" alt=""
					onclick="radioCheck('t-2')">
				</label> <label class="item" for="t-3">
					<p class="fff2">Design 1</p> <img
					src="/resources/images/theRed/theRed1.png" alt=""
					onclick="radioCheck('t-3')">
				</label> <label class="item" for="t-4">
					<p class="fff2">Design 2</p> <img
					src="/resources/images/theRed/theRed2.png" alt=""
					onclick="radioCheck('t-4')">
				</label> <label class="item" for="t-5">
					<p class="fff2">Design 3</p> <img
					src="/resources/images/theRed/theRed3.png" alt=""
					onclick="radioCheck('t-5')">
				</label>
			</div>
			<br />
			<div class="dots">
